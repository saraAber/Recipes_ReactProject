...
const GetRecipes = () => {
  ...
  const filteredRecipes = recipes.filter(recipe =>
    ...
    (filterDuration !== '' ? recipe.Duration <= filterDuration : true) &&
                  ...
                  <Card sx={{ margin: 2, textAlign: 'right' }}>
                    <CardContent>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <Button onClick={() => console.log("אהבתי מתכון")} style={{ color: 'green' }}>
                          <ThumbUpIcon />
                        </Button>
                      </div>
                      ...
                      {recipe.Ingridents?.length ? (
                        recipe.Ingridents.map((ing) => (
                          <Typography key={`${recipe.Id}-${ing.Name}`} style={{ textAlign: 'right' }}>
                      ...
                      {recipe.Instructions?.length ? (
                        ...
                        <Typography variant="body2">אין הוראות זמינות</Typography>
                      )}
                    </CardContent>
                  </Card>
                </Grid>
