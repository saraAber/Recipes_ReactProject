...
function HomePage() {
  ...
  return (
    <div className="home-container">
      <img src="https://shanisanders.com/wp-content/uploads/2021/03/fraisier-cake.jpg" alt="עוגת תותים על עמוד" />
      ...
      <div className="button-group">
        ...
        <button onClick={() => navigate("/recipes")}>📋 הצגת מתכונים</button>
        <button onClick={() => navigate("/addRecipe")}>➕ הוספת מתכון</button>
      </div>
